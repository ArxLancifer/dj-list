    ...
    loginUser: async function(req, res){
        ...
        try {
         ...
         await refreshToken.save();
            res.json({userToken, username:user.username, id:user._id, favoriteLists:user.favoriteLists, accountSince:user.createdAt, email:user.email, userimage:user.userimage});
          }else {
